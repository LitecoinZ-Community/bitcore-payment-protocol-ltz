...
```
npm install bitcore-lib-ltz --save
npm install bitcore-payment-protocol-ltz --save
```

For client-side projects:

```
bower install bitcore-lib-ltz --save
bower install bitcore-payment-protocol-ltz --save
```
